...
//
//   ➜ 1. Resolve DB + CDN_PREFIX from the map
//        ✓ Matched root 'x' (DB u@h:3306)
//   ➜ 2. WordOps site
//        ✓ Created
// ============================================================
 ...
 * @param {object} [opts]
 *   nested=true → this operation is running inside another one (e.g. cleanup
 *                 during a deploy's rotation). Its "steps" become indented
 *                 detail lines so the parent's numbering stays continuous.
 */
